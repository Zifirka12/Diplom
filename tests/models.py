...
from learning_platform.models import Lesson
...
class Test(models.Model):
    lesson = models.ForeignKey(
        ...
        related_name='lesson_tests',  # Изменено с 'tests' на 'lesson_tests'
        verbose_name="Урок"
    )
...
class TestAttempt(models.Model):
    ...
    def __str__(self):
        return f"{self.user.get_full_name()} - {self.test.title} ({self.score}%)" 